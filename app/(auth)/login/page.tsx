  ...
  return (
    <main style={{ minHeight: "calc(100vh - 80px)", backgroundColor: "var(--cream)", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 24px" }}>
      <div style={{ width: "100%", maxWidth: "400px" }}>
        ...
        <p style={{ fontFamily: "var(--in)", fontSize: "17px", color: "rgba(17,17,17,0.6)", marginBottom: "36px" }}>
          Sign in to your Imani Ventures account.
        </p>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <Link href="/forgot-password" style={{ fontFamily: "var(--in)", fontSize: "15px", color: "var(--crimson)", textDecoration: "none" }}>
                Forgot password?
              </Link>
            </div>
            <div style={{ position: "relative" }}>
              <input
                ...
                style={{ fontFamily: "var(--in)", fontSize: "17px", padding: "11px 44px 11px 14px", border: "1px solid var(--hairline)", backgroundColor: "var(--cream)", color: "var(--ink)", outline: "none", width: "100%", boxSizing: "border-box" }}
              />
              <button
                type="button"
        ...
        <p style={{ fontFamily: "var(--in)", fontSize: "16px", color: "rgba(17,17,17,0.6)", marginTop: "28px", textAlign: "center" }}>
          ...
          <Link href="/signup" style={{ color: "var(--crimson)", textDecoration: "none", fontWeight: 500 }}>
            Create one
          </Link>
        </p>
      </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div style={{ minHeight: "calc(100vh - 80px)", backgroundColor: "var(--cream)" }} />}>
      <LoginForm />
    </Suspense>
  );
}
