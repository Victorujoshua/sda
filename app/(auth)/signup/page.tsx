          ...
          {done ? (
            <div style={{ maxWidth: 440 }}>
              ...
              <p style={{ fontFamily: "var(--in)", fontSize: "18px", color: "rgba(17,17,17,0.5)", lineHeight: 1.6, margin: "0 0 40px" }}>
                We sent a confirmation link to <strong style={{ color: "var(--ink)", fontWeight: 500 }}>{email}</strong>. Click it to activate your account, then continue your application.
              </p>
